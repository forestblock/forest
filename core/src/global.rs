...
pub const USER_TESTING_MIN_EDGE_BITS: u8 = 22;//15;
	...
	T: EdgeType + 'static,
{
	...
	match chain_type {
		...
		//ChainTypes::Mainnet if edge_bits == 19 => new_cuckaroo_ctx(edge_bits, proof_size),
		ChainTypes::Mainnet => new_cuckatoo_ctx(edge_bits, proof_size, max_sols),

		// Same for Floonet
		//ChainTypes::Floonet if edge_bits == 19 => new_cuckaroo_ctx(edge_bits, proof_size),
